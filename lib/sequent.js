...
(function() {
  var DEBUG, Sequent, doImmediately, idCounter, _ref,
    __slice = [].slice;

  DEBUG = false;

  doImmediately = (_ref = typeof process !== "undefined" && process !== null ? process.nextTick : void 0) != null ? _ref : function(callback) {
        ...
        if (_this.executedLoops === loops) {
          ...
          if (_this.readyLoops[loops + 1]) {
            ...
            return doImmediately(function() {
              var _ref1;
              return (_ref1 = _this.loopCallbacks)[loops + 1].apply(_ref1, args);
            });
          } else {
            if (DEBUG) {
          ...
          return _this.readyLoops[loops] = true;
        }
      };
    };
